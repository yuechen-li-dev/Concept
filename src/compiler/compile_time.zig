...
pub const CompileTimeEvaluator = struct {
    ...
    pub fn evaluateExpr(self: *CompileTimeEvaluator, expr_id: hir.ExprId) CompileTimeResult {
        ...
        return switch (expr.kind) {
            ...
            .slice_len, .fixed_buffer_empty, .fixed_buffer_append, .fixed_buffer_len, .fixed_buffer_capacity, .option_some, .option_none, .option_is_some, .option_is_none, .option_or => error.UnsupportedExpression,
    ...
    fn executeStmt(self: *CompileTimeEvaluator, stmt_id: hir.StmtId) CompileTimeError!ExecResult {
        ...
        return switch (stmt.kind) {
            ...
            .expr_stmt, .discard_stmt, .panic_stmt, .assert_stmt, .yield_stmt, .transition_stmt, .arena_reset, .arena_destroy, .unsafe_block, .match_stmt => error.UnsupportedStatement,
        };
    }
