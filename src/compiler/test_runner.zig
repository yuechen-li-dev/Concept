...
const Runner = struct {
    ...
    fn evaluateExpr(self: *Runner, expr_id: hir.ExprId, frame: *Frame) RunError!Value {
        ...
        return switch (expr.kind) {
            ...
            .slice_len, .fixed_buffer_empty, .fixed_buffer_append, .fixed_buffer_len, .fixed_buffer_capacity, .option_some, .option_none, .option_is_some, .option_or => error.UnsupportedConstruct,
