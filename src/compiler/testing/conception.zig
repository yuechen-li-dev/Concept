...
test "language run fixtures: phase20 DragonGod Kernel core seed" {
    ...
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_enter_exit_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_transition_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_yield_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_signal_succeed_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_event_order_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_capacity_panics_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_signal_reason_match_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_trace_sink_interface_smoke_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_graph_add_find_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_graph_root_run.valid.conception");
    try expectRunFixture("../../../language/phase20-dragongod-kernel/valid/kernel_graph_kind_code_run.valid.conception");
...
test "language check fixtures: phase21 arrays slices fixed buffers" {
    ...
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_index_assignment_constant_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_index_assignment_variable_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_index_assignment_nested_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_value_assignment_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_value_parameter_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_value_return_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_value_nested_assignment_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_value_struct_field_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/array_value_dynamic_index_after_copy_run.valid.conception");
    ...
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/slice_param_first_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/slice_param_len_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/slice_param_dynamic_index_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/fixed_buffer_empty_len_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/fixed_buffer_append_read_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/fixed_buffer_capacity_run.valid.conception");
    try expectRunFixture("../../../language/phase21-arrays-slices-fixed-buffers/valid/fixed_buffer_value_copy_run.valid.conception");
    ...
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/array_index_assignment_type_mismatch.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/array_index_assignment_constant_high.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/array_index_assignment_temporary.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/array_assignment_length_mismatch.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/array_assignment_element_type_mismatch.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/slice_index_non_integer.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/slice_element_assignment.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/slice_param_element_type_mismatch.invalid.conception");
    try expectCheckFixture("../../../language/phase21-arrays-slices-fixed-buffers/invalid/fixed_buffer_capacity_zero.invalid.conception");
