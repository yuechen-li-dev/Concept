...
| reference allocator framework | post-R6l | Blocked | R6l resolved direct generic bind, owner field state, destruction, move, and Value provenance; nested generic Result/Option carrier substitution remains |
