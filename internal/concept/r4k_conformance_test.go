...
var evt1R4kConformanceCases = []struct {
	file       string
	accepted   bool
	diagnostic string
}{
...
func generateR4kFixture(t *testing.T, class, file string) Outputs {
	t.Helper()
	path := filepath.Join("..", "..", "language", "evt1-r4k", "core", class, file)
...
func TestEVT1R4kConformance(t *testing.T) {
	for _, tc := range evt1R4kConformanceCases {
		t.Run(tc.file, func(t *testing.T) {
			path := filepath.Join("..", "..", "language", "evt1-r4k", "core", filepath.FromSlash(tc.file))
			source, err := os.ReadFile(path)
			if err != nil {
				t.Fatal(err)
			}
...
func TestEVT1R4kClassMembersDefaultPrivate(t *testing.T) {
...
func TestEVT1R4kWitnessMIRAndCShape(t *testing.T) {
...
func TestEVT1R4kRejectsMalformedWitnessMIR(t *testing.T) {
...
func TestEVT1R4kRejectsMalformedDynMIR(t *testing.T) {
...
func TestEVT1R4kNativeC11(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.file, func(t *testing.T) {
			...
			runR1NativeHarness(t, fixture, "r4k_"+tc.file+".c", tc.harness)
		})
	}
}
