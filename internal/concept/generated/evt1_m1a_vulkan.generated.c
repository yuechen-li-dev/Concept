/* Generated by concept-evt1-stage0-go. DO NOT EDIT. Source: Examples/Concept-Vulkan/evt1_m1a_vulkan.concept */
...
static concept_pipeline_state concept_pipeline_state_make_failed(concept_vulkan_error error) {
  concept_pipeline_state out;
  out.tag = CONCEPT_PIPELINE_STATE_FAILED;
...
concept_pipeline_state concept_evt1_m1a_vulkan_make_failed_state(concept_vulkan_error error) {
  concept_vulkan_error cv_payload_01 = error;
  ...
  case CONCEPT_PIPELINE_STATE_READY:
    {
      ...
      concept_evt1_m1a_vulkan_destroy_pipeline_layout(cv_arg_04);
      break;
    }
  case CONCEPT_PIPELINE_STATE_FAILED:
    {
