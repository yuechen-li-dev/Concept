...
func (d Diagnostic) SemanticCategory() string {
	switch d.Code {
	case "PLAN_UNSUPPORTED_MIR", "PLAN_TARGET_UNSUPPORTED", "PLAN_REQUIRED_FACT_MISSING", "PLAN_REQUIRED_FACT_DISPROVEN", "PLAN_INVALID_STRATEGY", "PLAN_RUNTIME_GUARD_MISSING", "PLAN_CLEANUP_INCOMPLETE", "PLAN_WITNESS_INVALID", "PLAN_TENSOR_INVALID", "PLAN_ARTIFACT_INVALID", "PLAN_AUTOMATA_INVALID":
