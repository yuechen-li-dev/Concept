...
var spanConformanceCases = []ConformanceCase{
...
func TestSpanConformance(t *testing.T) {
	counts := map[ConformanceExpectation]int{}
	for _, tc := range spanConformanceCases {
		t.Run(tc.Name, func(t *testing.T) {
			path := filepath.Join("..", "..", "language", "evt1", "storage", "span", filepath.FromSlash(tc.Source))
...
func TestSpanMIRValidationRejectsIncompleteSpanFacts(t *testing.T) {
...
func TestSpanRuntimeBoundsPanics(t *testing.T) {
