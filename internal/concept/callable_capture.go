...
// Callable capture deliberately reuses the ordinary binding scope. A callable body sees
...
func evt1CallableTypeGeometry(env *semanticEnv, t Type) (int, int) {
	...
	// New callable forms must add an explicit case above rather than silently changing this law.
	return 8, 8
}
