...
type r4bConformanceCase struct {
	name             string
	source           string
	accepted         bool
...
var evt1R4bConformanceCases = []r4bConformanceCase{
...
func TestEVT1R4bConformance(t *testing.T) {
	accepted, rejected := 0, 0
	for _, tc := range evt1R4bConformanceCases {
		t.Run(tc.name, func(t *testing.T) {
			if tc.classification == "" || tc.provenance == "" {
				t.Fatal("classification and provenance are required")
			}
			path := filepath.Join("..", "..", "language", "evt1-r4b", "core", filepath.FromSlash(tc.source))
...
func TestEVT1R4bMIRRelationalEvidence(t *testing.T) {
...
func TestEVT1R4bNestedResultSummary(t *testing.T) {
...
func TestEVT1R4bPassThroughResultSummary(t *testing.T) {
...
func TestEVT1R4bShortestOfParametersSummary(t *testing.T) {
...
func TestEVT1R4bRelationalSubjectValidation(t *testing.T) {
...
func TestEVT1R4bUnknownCallResultAssignment(t *testing.T) {
...
func TestEVT1R4bByValueParameterIsNotReturnableStorage(t *testing.T) {
...
func TestEVT1R4bNativeC11(t *testing.T) {
	cases := []struct {
		fixture string
		call    string
		want    int
...
func generateR4bFixture(t *testing.T, fixture string) Outputs {
	t.Helper()
	path := filepath.Join("..", "..", "language", "evt1-r4b", "core", "valid", fixture)
	source, err := os.ReadFile(path)
	if err != nil {
		t.Fatal(err)
	}
