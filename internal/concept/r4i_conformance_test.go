...
var evt1R4iConformanceCases = []ConformanceCase{
...
func generateR4iFixture(t *testing.T, class, file string) Outputs {
	t.Helper()
	path := filepath.Join("..", "..", "language", "evt1-r4i", "core", class, file)
...
func TestEVT1R4iConformance(t *testing.T) {
	counts := map[ConformanceExpectation]int{}
	for _, tc := range evt1R4iConformanceCases {
		t.Run(tc.Name, func(t *testing.T) {
			path := filepath.Join("..", "..", "language", "evt1-r4i", "core", filepath.FromSlash(tc.Source))
			source, err := os.ReadFile(path)
			if err != nil {
				t.Fatal(err)
			}
...
func TestEVT1R4iInlineBackingAndTensorMIR(t *testing.T) {
...
func TestEVT1R4iRankZeroTensorMIR(t *testing.T) {
...
func TestEVT1R4iMIRValidationRejectsIncompleteInlineBacking(t *testing.T) {
...
func TestEVT1R4iNativeC11(t *testing.T) {
	cases := []struct {
		file string
		call string
		want string
	...
	for _, tc := range cases {
		t.Run(tc.file, func(t *testing.T) {
			...
			runR1NativeHarness(t, outputs, "r4i_harness.c", harness)
		})
	}
}

func TestEVT1R4iDefaultInitializationUsesExistingLaw(t *testing.T) {
...
func TestEVT1R4iAliasTypeIdentity(t *testing.T) {
...
func TestEVT1R4iBackingClassification(t *testing.T) {
	cases := []struct {
		class string
		file  string
...
func TestEVT1R4iPreservedBackingClassification(t *testing.T) {
	cases := []struct {
		file string
		want TensorBackingKind
	}{
