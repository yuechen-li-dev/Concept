...
func (l *lowering) generateC() ([]byte, []byte, error) {
	...
	if evt1UsesVulkanError(l.module) {
		header.WriteString("typedef struct concept_vulkan_error {\n  int Code;\n} concept_vulkan_error;\n\n")
	}
...
func evt1CType(t Type) string {
	...
	case "VulkanError":
		return "concept_vulkan_error"
	default:
		return evt1CName(t.Name)
	}
}

func evt1NeedsVulkan(module Module) bool {
	return evt1TypeUsed(module, func(t Type) bool {
		return t.Name == "PipelineLayout" || t.Name == "Pipeline" || strings.HasPrefix(t.Name, "Vk")
	})
}

func evt1UsesVulkanError(module Module) bool {
	return evt1TypeUsed(module, func(t Type) bool { return t.Name == "VulkanError" })
}
